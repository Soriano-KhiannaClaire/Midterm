...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2024 at 07:54 PM
...
(2, 'khiannasoriano', '$2y$10$cO/ZYhfKjWxqd/cVaTItz.3wtG7AJ31F8aTS4bBVhTe482yhe4jgG', 'khianna@example.com');
...
INSERT INTO `menu_items` (`id`, `restaurant_id`, `name`, `price`, `description`) VALUES
(1, 1, 'Chicken', 99.00, 'Crispy Chicken Joy');
...
(1, 'Jollibee', 'FastFood', 'Balanga City');
